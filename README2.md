# On this doc we will deploy the API on Poridhi`s cloud and test the endpoins
...
```
### Expected output
![APP_RUN](images2/dockerbuild.png)
...
```
### Expected output
![APP_RUN](images2/logoutcurl.png)
